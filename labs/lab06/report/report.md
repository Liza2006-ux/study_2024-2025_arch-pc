...
(𝑆 mod 20) + 1, где 𝑆 – номер студенческого билета(Вданномслучае � mod � – это остаток от деления � на �), потомвывеланаэкранномер варианта. Создала файл variant.asm в каталоге ~/work/arch-pc/lab06:
...
Выполнение самостоятельной работы. Написала программу вычисления выражения y = f(x). (Программа должна выводить выражение для вычисления, выводитьзапрос на ввод значения x, вычислять заданное выражение взависимостиот введенного x, выводить результат вычислений.)
